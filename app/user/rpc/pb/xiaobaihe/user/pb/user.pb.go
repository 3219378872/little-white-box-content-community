...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x04user\"\xf9\x02\n" +
	"\bUserInfo\x12\x0e\n" +
...
var file_user_proto_depIdxs = []int32{
	...
	0,  // 2: user.SearchUsersResp.users:type_name -> user.UserInfo
	0,  // 3: user.GetFollowersResp.users:type_name -> user.UserInfo
	0,  // 4: user.GetFollowingResp.users:type_name -> user.UserInfo
	0,  // 5: user.LoginResp.user:type_name -> user.UserInfo
	1,  // 6: user.UserService.GetUser:input_type -> user.GetUserReq
	3,  // 7: user.UserService.BatchGetUsers:input_type -> user.BatchGetUsersReq
	5,  // 8: user.UserService.SearchUsers:input_type -> user.SearchUsersReq
	7,  // 9: user.UserService.UpdateProfile:input_type -> user.UpdateProfileReq
	9,  // 10: user.UserService.Follow:input_type -> user.FollowReq
	11, // 11: user.UserService.Unfollow:input_type -> user.UnfollowReq
	13, // 12: user.UserService.GetFollowers:input_type -> user.GetFollowersReq
	15, // 13: user.UserService.GetFollowing:input_type -> user.GetFollowingReq
