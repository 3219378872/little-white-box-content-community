...
func (m *defaultTagModel) Insert(ctx context.Context, data *Tag) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Id, data.Name, data.Description, data.Icon, data.PostCount, data.FollowCount, data.Status)
	}, tagIdKey, tagNameKey)
	return ret, err
}
...
func (m *defaultTagModel) Update(ctx context.Context, newData *Tag) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Name, newData.Description, newData.Icon, newData.PostCount, newData.FollowCount, newData.Status, newData.Id)
	}, tagIdKey, tagNameKey)
	return err
}
