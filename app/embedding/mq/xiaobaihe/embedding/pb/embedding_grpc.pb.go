...
const (
	...
	EmbeddingService_EmbedBatch_FullMethodName = "/embedding.EmbeddingService/EmbedBatch"
...
type EmbeddingServiceClient interface {
	...
	EmbedBatch(ctx context.Context, in *EmbedBatchReq, opts ...grpc.CallOption) (*EmbedBatchResp, error)
	Health(ctx context.Context, in *EmbeddingHealthReq, opts ...grpc.CallOption) (*EmbeddingHealthResp, error)
}
...
func (c *embeddingServiceClient) Embed(ctx context.Context, in *EmbedReq, opts ...grpc.CallOption) (*EmbedResp, error) {
...
func (c *embeddingServiceClient) EmbedBatch(ctx context.Context, in *EmbedBatchReq, opts ...grpc.CallOption) (*EmbedBatchResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmbedBatchResp)
...
func (c *embeddingServiceClient) Health(ctx context.Context, in *EmbeddingHealthReq, opts ...grpc.CallOption) (*EmbeddingHealthResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmbeddingHealthResp)
...
type EmbeddingServiceServer interface {
	...
	EmbedBatch(context.Context, *EmbedBatchReq) (*EmbedBatchResp, error)
	Health(context.Context, *EmbeddingHealthReq) (*EmbeddingHealthResp, error)
...
func (UnimplementedEmbeddingServiceServer) Embed(context.Context, *EmbedReq) (*EmbedResp, error) {
	return nil, status.Error(codes.Unimplemented, "method Embed not implemented")
}
func (UnimplementedEmbeddingServiceServer) EmbedBatch(context.Context, *EmbedBatchReq) (*EmbedBatchResp, error) {
	return nil, status.Error(codes.Unimplemented, "method EmbedBatch not implemented")
}
func (UnimplementedEmbeddingServiceServer) Health(context.Context, *EmbeddingHealthReq) (*EmbeddingHealthResp, error) {
...
func _EmbeddingService_Embed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbeddingServiceServer).Embed(ctx, req.(*EmbedReq))
	}
...
func _EmbeddingService_EmbedBatch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbeddingServiceServer).EmbedBatch(ctx, req.(*EmbedBatchReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EmbeddingService_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmbeddingServiceServer).Health(ctx, req.(*EmbeddingHealthReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EmbeddingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/embedding/embedding.proto",
}
