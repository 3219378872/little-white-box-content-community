...
| 设计页 | 上游规范 | 状态 |
| --- | --- | --- |
| [DES-content-community-backend](DES-content-community-backend.md) | SPEC-community-core / SPEC-content-discovery / SPEC-grounded-assistant / SPEC-feedback-reliability | active |
