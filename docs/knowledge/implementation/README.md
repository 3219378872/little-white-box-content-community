...
| 实现页 | 上游设计 | 状态 | 证据 |
| --- | --- | --- | --- |
| [IMP-content-community-backend](IMP-content-community-backend.md) | DES-content-community-backend | diverged | 2026-08-13（关注流当前关系/去缓存读取已落地；CORE-013/搜索 Total/评测/SLO 仍偏离） |
