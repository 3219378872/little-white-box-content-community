...
| 实现页 | 上游设计 | 状态 | 证据 |
| --- | --- | --- | --- |
| [IMP-content-community-backend](IMP-content-community-backend.md) | DES-content-community-backend | diverged | 2026-08-13（公开列表回源与 GetPost.status 已落地；CORE-013/评测/SLO 仍偏离） |
