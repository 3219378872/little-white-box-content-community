...
func TestProductionComposeParsesAndCoversRuntimeTopology(t *testing.T) {
	...
	for _, key := range []string{
		"ASSISTANT_LLM_MODEL_SMALL", "ASSISTANT_LLM_REVIEW_MODEL",
		"ASSISTANT_LLM_CACHE_READ_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_CACHE_WRITE_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_REASONING_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_FALLBACK_ENABLED", "ASSISTANT_LLM_FALLBACK_ROUTE_ID",
		"ASSISTANT_LLM_FALLBACK_BOUNDARY", "ASSISTANT_LLM_FALLBACK_WIRE_API",
		"ASSISTANT_LLM_FALLBACK_ENDPOINT", "ASSISTANT_LLM_FALLBACK_API_KEY",
		"ASSISTANT_LLM_FALLBACK_MODEL",
		"ASSISTANT_LLM_FALLBACK_PROMPT_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_FALLBACK_COMPLETION_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_FALLBACK_CACHE_READ_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_FALLBACK_CACHE_WRITE_COST_PER_MILLION_TOKENS",
		"ASSISTANT_LLM_FALLBACK_REASONING_COST_PER_MILLION_TOKENS",
	} {
		if _, ok := project.Services["assistant-agent"].Environment[key]; !ok {
			t.Errorf("production assistant-agent environment is missing %s", key)
		}
	}
...
func loadProductionCompose(t *testing.T) composeProject {
	...
	values := map[string]string{
		...
		"ASSISTANT_LLM_CACHE_READ_COST_PER_MILLION_TOKENS":  "0",
		"ASSISTANT_LLM_CACHE_WRITE_COST_PER_MILLION_TOKENS": "0",
		...
		"ASSISTANT_LLM_REASONING_COST_PER_MILLION_TOKENS":   "0",
		"ASSISTANT_LLM_REVIEW_MODEL":                        "",
		"ASSISTANT_LLM_WIRE_API":                            "responses",
		"ASSISTANT_LLM_FALLBACK_ENABLED":                    "false",
