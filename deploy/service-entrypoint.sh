...
for secret_name in \
  JWT_SECRET_KEY JWT_REFRESH_SECRET RPC_INTERNAL_SECRET REDIS_PASS REDIS_PASSWORD \
  DB_USER DB_CONTENT DB_MEDIA DB_INTERACTION DB_FEED DB_MESSAGE DB_ASSISTANT \
