...
CREATE TABLE IF NOT EXISTS `post` (
    ...
    `media_ids` JSON DEFAULT NULL COMMENT '引用的已上传媒体ID列表（CORE-024）',
...
-- Transactional event outbox. The relay publishes only committed rows and
-- acknowledges them after RocketMQ confirms receipt.
