...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/elasticsearch v0.42.0 // indirect
	github.com/testcontainers/testcontainers-go/modules/milvus v0.42.0 // indirect
